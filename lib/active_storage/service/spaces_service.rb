...
class ActiveStorage::Service::SpacesService < ActiveStorage::Service
  attr_reader :client, :bucket

  ENDPOINT_BASE = "digitaloceanspaces.com"
  ENDPOINT_PROTOCOL = "https"

  def initialize(access_key_id:, secret_access_key:, region:, bucket:)
    @client = Aws::S3::Resource.new(access_key_id: access_key_id, secret_access_key: secret_access_key, endpoint: "#{ENDPOINT_PROTOCOL}://#{region}.#{ENDPOINT_BASE}", region: region)
